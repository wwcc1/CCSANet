...
parser.add_argument('--resume', type=str, default='I:/new cx program/fewshot-CAN-master - 80.52%/result/miniImageNet/CAM/5-shot-seed112/best_model.pth.tar', metavar='PATH') #'G:/few shot code/fewshot-CAN-master - 80.52%/result\miniImageNet\CAM/5-shot-seed112/checkpoint_ep10.pth', metavar='PATH')
# FewShot settting
