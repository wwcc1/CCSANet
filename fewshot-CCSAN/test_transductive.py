...
parser.add_argument('--save-dir', type=str, default='I:/new cx program/fewshot-CAN-master - 80.52%/result\miniImageNet\CAM/5-shot-seed112')#'G:/few shot code/fewshot-CAN-master - 80.52%/result/miniImageNet/CAM/5-shot-seed112/')
parser.add_argument('--resume', type=str, default='I:/new cx program/fewshot-CAN-master - 80.52%/result\miniImageNet\CAM/5-shot-seed112/best_model.pth.tar', metavar='PATH')#'G:/few shot code/fewshot-CAN-master - 80.52%/result\miniImageNet\CAM/5-shot-seed112/best_model.pth.tar', metavar='PATH')
# FewShot settting
...
parser.add_argument('--nTestNovel', type=int, default=15 * 5,#15
...
def main():
    ...
    sys.stdout = Logger(osp.join(args.save_dir, 'log_test_tranductive.txt'))
    print("==========\nArgs:{}\n==========".format(args))
...
def test(model, testloader, use_gpu):
    ...
    with torch.no_grad():
        for batch_idx , (images_train, labels_train, images_test, labels_test) in enumerate(testloader):
            ...
            cls_scores = model.test_transductive(images_train, images_test, labels_train_1hot, labels_test_1hot)
