...
class miniImageNet_load(object):
    ...
    """
    dataset_dir = 'I:/new cx program/fewshot-CAN-master - 80.52%/torchFewShot/datasets/mini-imagenet/'#'/home/houruibing/code/few-shot/MiniImagenet/'
    ...
    def _check_before_run(self):
        ...
        if not os.path.exists(self.train_dir):          ##osp.exists(self.train_dir)
