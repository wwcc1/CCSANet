...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, kernel=3,zero_init_residual=False):
        self.inplanes = 64
        self.kernel = kernel
        super(ResNet, self).__init__()
        self.conv1 = nn.Conv2d(3, 64, kernel_size=3, stride=1, padding=1, bias=False)#1=6 #8=7 #16=8 #24=9
        ...
        # self.nFeat = 131328 * block.expansion
...
if __name__ == '__main__':
    c=ResNet(BasicBlock, [1,1,1,1], kernel=3)
    b=torch.rand(140, 3, 84, 84)
    a =c(b)
    print(a.size())